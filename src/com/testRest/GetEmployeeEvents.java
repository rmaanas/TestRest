...
public class GetEmployeeEvents {
	...
	public Response getevents(String data){
		...
		try{
			...
			String sql = "SELECT EVENT.EVENTID, EVENT.VISITID, EVENT.NAME, EVENT.STARTTIME,EVENT.ENDTIME,"
					+ "EVENT.DUEDATE,EVENT.VENUE,EVENT.STATUS, "
					+ "VISIT.PROJECTID, VISIT.VISITDATE, "
					+ "PROJECT.NAME,PROJECT.MANAGER,PROJECT.CLIENTHEAD,PROJECT.ORGANISATION FROM EVENT,VISIT,PROJECT "
